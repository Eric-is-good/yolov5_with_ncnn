...
def run(
        ...
        weights=ROOT / 'yolov5n.pt',  # weights path
    ...
    # class yolo_with_three(nn.Module):
    #     def __init__(self):
    #         super(yolo_with_three, self).__init__()
    #         self.yolo = attempt_load(weights, map_location=device, inplace=True, fuse=True)
    #         self.nc, self.names = self.yolo.nc, self.yolo.names
    #         self.stride = self.yolo.stride
    #
    #     def forward(self, img):
    #         pred = self.yolo(img)[1]
    #         i = 0
    #         for juzheng in pred:
    #             pred[i] = juzheng.view(juzheng.shape[0], juzheng.shape[1], juzheng.shape[2] * juzheng.shape[3],
    #                                    juzheng.shape[4])
    #             i = i + 1
    #         return pred
    #
    # model = yolo_with_three()
